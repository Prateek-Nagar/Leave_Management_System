...
$result=mysqli_query($conn,"SELECT * FROM tboptions,questions where questions.question_id=tboptions.question_id")
...
<form name="fmOptions" id="fmOptions" action="inserto.php" method="post" onsubmit="return optionValidate(this)">
<tr>
    <td>Option</td>
...
<tr>
    <td>Question</td>
    <td><SELECT name="question" id="question">select
